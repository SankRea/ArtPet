...
contextBridge.exposeInMainWorld('arkpet', {
  ...
  setAi: value => ipcRenderer.invoke('launcher:ai-settings', value),
  listAiModels: value => ipcRenderer.invoke('launcher:ai-models', value),
  testAi: value => ipcRenderer.invoke('launcher:ai-test', value),
  clearAiKey: () => ipcRenderer.invoke('launcher:ai-key-clear'),
